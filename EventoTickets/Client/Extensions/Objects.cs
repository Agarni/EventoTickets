...
namespace EventoTickets.Client.Extensions
{
    // ============================================================================
    ...
    public static class Objects
    {
        ...
        {
            return IsField(member) || (IsProperty(member)
                && ((System.Reflection.PropertyInfo)member).CanWrite);
        }

        private static bool CanRead(System.Reflection.MemberInfo member)
        {
            return IsField(member) || (IsProperty(member)
                && ((System.Reflection.PropertyInfo)member).CanRead);
        }
